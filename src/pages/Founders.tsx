        ...
        <section className="py-12 px-4">
          <div className="container mx-auto">
            ...
            delay: 0.2
              ...
              {founders.map((founder, index) => <Card key={index} className="bg-card text-card-foreground shadow-md hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {founder.expertise.map((skill, i) => <span key={i} className="inline-block bg-secondary text-secondary-foreground px-3 py-1 rounded-full text-sm font-medium">{skill}</span>)}
                    </div>
                  </CardContent>
                </Card>)}
            </motion.div>
          ...
          <div className="container mx-auto">
            ...
            delay: 0.6
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {coreValues.map((value, index) => <Card key={index} className="bg-card text-card-foreground shadow-md hover:shadow-lg transition-shadow duration-300">
